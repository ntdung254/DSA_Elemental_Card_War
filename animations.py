...
class AnimationManager: # Quản lý các trạng thái rung màn hình và các hiệu ứng chuyển động.
    ...
    def get_pulse(self, current_time, speed=0.003): # Tính toán giá trị nhịp đập
        return (math.sin(current_time * speed) + 1) / 2

    def get_blink(self, current_time, speed=0.005): # Tính toán giá trị nhấp nháy cho ô cờ
        return (math.sin(current_time * speed) + 1) / 2
